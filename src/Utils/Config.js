...
export const USER_BASE_URL = 'http://13.51.161.234:3001';
export const CLIENT_BASE_URL = 'http://13.51.161.234:3001/client';
export const ADMIN_BASE_URL = 'http://13.51.161.234:3001/admin';
